...
=======
      <div
        id="aboutText"
        className="flex-[2.5] text-xl mx-5 sm:mx-10 text-center"
      >
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
          ...
          out.
=======
          Thank you for visiting ❤︎{`<3`} If it feels right for you, please
          reach out.
>>>>>>> Stashed changes
        </p>
...
=======
      <div
        id="aboutImage"
        className="flex justify-center  items-start flex-1 mx-5 sm:mx-20 mb-5"
      >
        <img src="/src/assets/about.jpg" alt="standing and looking cute" className=" object-contain" />
>>>>>>> Stashed changes
