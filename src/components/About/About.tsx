  ...
  return (
    <>
      ...
      >
        <div
          id="aboutText"
          className="flex-1 text-xl md:ml-[5%] lg:ml-[20%] text-center md:mx-0 mx-10 "
        >
          ...
          <p className="mb-4 ">
            ...
            journey, I have delved into, practiced, and healed from ~
          </p>
          ...
          <p className="mb-4">Please reach out to connect.</p>
        ...
        <div
          id="aboutImage"
          className="flex justify-center items-start flex-1 mb-5 mt-5 md:mr-[18%] sm:mt-5 overflow-hidden  mx-10 md:mx-0"
        >
          <img
            src={about}
