...
function LemonDrop() {
  ...
  const juice = `M18 ${63 + counter} C15 ${63 + counter} 16 ${63 + counter
    } 12 61L9 56C2 33 62 -3 80 12C103 27 44 56 29 58C27 58 25 59 24 61C20 ${63 + counter
  ...
  return (
    <>
      ...
      >
        <circle cx="18" cy={dropy} r="4" fill="pink"></circle>
        <path
