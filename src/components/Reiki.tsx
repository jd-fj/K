  ...
  return (
    <>
      <div id="ReikiParentDiv" className="flex flex-col lg:flex-row lg:mt-4">
        ...
        <div id="ReikiSection1" className="mb- w-2/3 mx-auto mt-4 block lg:hidden"><img src={Flowers} /></div>

        <div id="ReikiSection2" className="mb-4 text-center mx-4 lg:order-1">
        ...
        <div id="ReikiSection3" className="mb-4 text-center font-bold mx-[2em] text-lg lg:order-3">
        ...
        <div id="ReikiSection5" className="mb-10 text-left w-1/4 mx-auto lg:order-2">
          <SmallSwirlyHand />
        </div>
